...
### 3.3b Continuing later
Superseded: a stage checkpoint was tried and dropped the same day. The user meant a run left **half-way** should continue from exactly that point. See run-resume.md.
